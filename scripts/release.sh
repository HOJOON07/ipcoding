...
# hardened runtime(--options runtime)은 넣지 않는다: Library Validation이 켜지는데
# ad-hoc 서명은 팀 ID가 없어 메인-프레임워크 간 검증이 실패한다("different Team IDs"
# dyld 거부 — 2026-07-18 실측). 공증 없는 배포에선 hardened runtime 불필요.
